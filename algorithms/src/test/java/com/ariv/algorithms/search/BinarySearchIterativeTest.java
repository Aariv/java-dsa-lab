...
public class BinarySearchIterativeTest {
    ...
    void shouldFindMiddleElement() {
        ...
        int index = BinarySearchIterative.search(values, 30);
    ...
    void shouldFindFirstElement() {
        ...
        int index = BinarySearchIterative.search(values, 10);
    ...
    void shouldReturnMinusOneWhenMissing() {
        ...
        int index = BinarySearchIterative.search(values, 99);
    ...
    void shouldHandleSingleElementMissing() {
        ...
        int index = BinarySearchIterative.search(values, 20);
    ...
    void shouldWorkWithStrings() {
        ...
        int index = BinarySearchIterative.search(values, "banana");
    ...
    void shouldWorkWithCustomObjects() {
        ...
        int index = BinarySearchIterative.search(people, new Person("Bob", 25));
